#!/usr/bin/env python
# -*- coding: utf-8 -*-
'''Load several whole-image CSVs and hardcode sets of parameters for comparison.
   This is the script used for the planned figure 3.'''
...
bins = 25
rangemax = 0.25
namebases = ['100pa_1', '100pa_2', '50pa_0', '50pa_1', '50pa_2', '50pa_3', '50pa_4', '50pa_5']
fits = [[0.187, 0.671], [0.313, 0.618]]
...
for namebase in namebases:
    print("Going through namebase " + namebase)
    ...
    plt.semilogy(labels, values, color="gray")  #commented out plot of fit for now
    plt.grid()
...
for fit in fits:
    plt.semilogy(labels, pWeibull(labels, fit[0], fit[1]))
                
plt.legend(namebases+["Fit 50 Pa", "Fit 100 Pa"])
...
plt.savefig('publish_3.png', dpi=100)
